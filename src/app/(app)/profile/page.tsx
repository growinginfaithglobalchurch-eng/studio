  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <ScrollAnimator className="col-span-1 lg:col-span-1" delay={0.1}>
          <Card>
              <CardHeader>
        ...
        <ScrollAnimator className="col-span-1 lg:col-span-1" delay={0.2}>
          <Card>
              <CardHeader>
        ...
        <ScrollAnimator className="col-span-1 md:col-span-2 lg:col-span-1" delay={0.3}>
          <Card>
              <CardHeader>
