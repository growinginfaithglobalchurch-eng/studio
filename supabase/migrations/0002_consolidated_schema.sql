...
-- 21. Live Sessions / Replays Table
...
DROP POLICY IF EXISTS "Live sessions are public." ON live_sessions;
...
DROP POLICY IF EXISTS "Empowerment meetings are public." ON empowerment_meetings;
CREATE POLICY "Empowerment meetings are public." ON empowerment_meetings FOR SELECT USING (true);
DROP POLICY IF EXISTS "Admins can manage empowerment meetings." ON empowerment_meetings;
...
DROP POLICY IF EXISTS "Bible stories are public." ON bible_stories;
CREATE POLICY "Bible stories are public." ON bible_stories FOR SELECT USING (true);
DROP POLICY IF EXISTS "Admins can manage bible stories." ON bible_stories;
...
DROP POLICY IF EXISTS "Creative activities are public." ON creative_activities;
CREATE POLICY "Creative activities are public." ON creative_activities FOR SELECT USING (true);
DROP POLICY IF EXISTS "Admins can manage creative activities." ON creative_activities;
...
DROP POLICY IF EXISTS "Memory verse songs are public." ON memory_verse_songs;
CREATE POLICY "Memory verse songs are public." ON memory_verse_songs FOR SELECT USING (true);
DROP POLICY IF EXISTS "Admins can manage memory verse songs." ON memory_verse_songs;
